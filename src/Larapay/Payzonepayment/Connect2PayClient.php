...
use Larapay\PayzoneLaravel\C2PValidate;
use Larapay\PayzoneLaravel\TransactionStatus;
use Larapay\PayzoneLaravel\CartProduct;
use Larapay\PayzoneLaravel\Connect2PayCurrencyHelper;
  ...
  */
  private function validateFields() {
    ...
    foreach ($this->fieldsValidate as $field => $method) {
      if (!C2PValidate::isEmpty($this->{$field}) AND !call_user_func(array('\Larapay\PayzoneLaravel\C2PValidate', $method), $this->{$field}))
